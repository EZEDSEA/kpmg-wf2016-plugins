 ...
 * Copyright: 2016  
 * Created : 2016-09-18 10:39:36 AM
 * Last Modified : 2016-09-18T14:39:36Z
 */
...
OJAMBO;
	...
	public function adminFormAction()
	{
		...
		if ( $this->adminrole != NULL && ($_POST['kpmg_formaction'] == $this->formactionstep1) )
		{
			...
			$employeeListAndDetails = kpmg_getEmployeeListAndDetailsByEmail($dataArr['email_address']);
...
OJAMBO;
			...
			if ($this->errors == "" )
			{
				...
				else
				{
					...
					$insertiddata2['employee_email_address'] = $dataArr['email_address'];
					$insertiddatafieldtypes2 = kpmg_generateFieldTypes($insertiddata2);
					//$savedata = $saveArr;
					$insertdata2 = array(
						'is_group_host' => 1,
						'group_seat' => 0,
					...
					$insertfieldtypes2 = kpmg_generateFieldTypes($insertdata2);
					if ( $wpdb->update($wpdb->kpmg_registration_details, $insertdata2, $insertiddata2, $insertfieldtypes2, $insertiddatafieldtypes2) === FALSE )
					{
