...
/**
 * File: class.admin_reportmaster.php
 ...
 * Copyright: 2016  
 * Created : 2016-09-18 3:27:35 AM
 * Last Modified : 2016-09-18T07:27:35Z
 */
class KPMG_Admin_ReportMaster {
...
OJAMBO;
	...
	public function adminFormAction()
	{
		...
		if ( $this->adminrole != NULL && ($_POST['kpmg_formaction'] == $this->formaction) )
		{
			...
			if ( $this->errors == "" )
			{
				...
				$sql_report = "SELECT * FROM {$reportInTable}";
	...
	function adminReportData($data)
	{
		...
		foreach($data as $key => $row)
		{
			...
			{
				$arr[$key]['attend_entertainment_only'] = "Yes";
			}
			else
			{
				$arr[$key]['attend_entertainment_only'] = "No";
			}
